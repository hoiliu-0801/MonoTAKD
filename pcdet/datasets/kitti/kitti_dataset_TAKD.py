...
class KittiDataset_TAKD(DatasetTemplate_TAKD):
...
def create_kitti_infos_soft(dataset_cfg, class_names, data_path, save_path, split_name, your_label_path=None, workers=4):
    dataset = KittiDataset_TAKD(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
