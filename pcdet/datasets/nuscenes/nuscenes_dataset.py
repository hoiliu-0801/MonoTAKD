...
class NuScenesDataset(DatasetTemplate_LTKD):
    ...
    def load_camera_info(self, input_dict, info):
        ...
        # input_dict["image_paths"].append(info["cam_front_path"])
        # camera_intrinsics = np.eye(4).astype(np.float32)
        # input_dict["camera_intrinsics"].append(info["camera_intrinsics"])
        #### Why no cams items"""
...
if __name__ == '__main__':
    ...
    if args.func == 'create_nuscenes_infos':
        ...
        # ROOT_DIR = Path('/mnt/disk1')
        # print("ROOT_DIR:",type(Path(__file__)))
