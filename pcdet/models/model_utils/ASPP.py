...
class ASPP(nn.Module):
    def __init__(self):
        ...
        self.conv_1x1_1 = nn.Conv2d(128, 128, kernel_size=1)
        self.bn_conv_1x1_1 = nn.BatchNorm2d(128)

        self.conv_3x3_1 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=6, dilation=6)
        self.bn_conv_3x3_1 = nn.BatchNorm2d(128)

        self.conv_3x3_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=12, dilation=12)
        ...
        self.conv_1x1_2 = nn.Conv2d(128, 128, kernel_size=1)
