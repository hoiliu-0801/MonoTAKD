...
class ASPP(nn.Module):
    def __init__(self):
        ...
        self.conv_3x3_1 = nn.Conv2d(128, 64, kernel_size=3, stride=1, padding=6, dilation=6)
        self.bn_conv_3x3_1 = nn.BatchNorm2d(64)

        self.conv_3x3_2 = nn.Conv2d(128, 64, kernel_size=3, stride=1, padding=12, dilation=12)
        self.bn_conv_3x3_2 = nn.BatchNorm2d(64)

        # self.conv_3x3_3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=18, dilation=18)
        # self.bn_conv_3x3_3 = nn.BatchNorm2d(128)

        self.avg_pool = nn.AdaptiveAvgPool2d(1)

        self.conv_1x1_2 = nn.Conv2d(128, 64, kernel_size=1)
        self.bn_conv_1x1_2 = nn.BatchNorm2d(64)

        self.conv_1x1_3 = nn.Conv2d(256, 128, kernel_size=1) # (640 = 5*128)
